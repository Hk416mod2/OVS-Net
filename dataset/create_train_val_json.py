...
def create_segmentation_dataset_json(image_folder, mask_folder, train_json, val_json):
    ...
    for dataset_name, files in dataset_dict.items():
        ...
        for image_file in train_files:
            ...
            mask_paths = [os.path.join(mask_folder, f) for f in os.listdir(mask_folder) if f.startswith(image_file)]
...
mask_folder = '../masks'
train_json = 'image2label_train.json'
val_json = 'image2label_val.json'
