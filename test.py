...
def main():
    ...
    parser.add_argument("-checkpoint_path", type=str, default="./Workdir/VesselSeg-XXXXXXXX-XXXX")
    parser.add_argument("-test_data_root", type=str, default="./Dataset/test")
    parser.add_argument("-batch_size", type=int, default=1)
    parser.add_argument("-num_workers", type=int, default=4)
    parser.add_argument("--device", type=str, default="cuda:0")
    parser.add_argument("--save_dir", type=str, default='prediction', help='save predicttion')
